...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        networkPath = intent.getStringExtra("NETWORK_PATH");
        networkType = intent.getStringExtra("NETWORK_TYPE");
        Toast.makeText(getApplicationContext(), "网络连接类型： " + networkType + " 连接地址：" + networkPath, Toast.LENGTH_SHORT).show();
